...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="keywords" content="Charity, Manager, Member registration, Donation, Donations Manager" />
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>CHARITY MANAGER <span>ACCESS POINT</span></h1>
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="login.php" method="POST" autocomplete="on"> 
                                ...
                                <p class="change_link">
									Not a member yet ?
									<a href="#toregister" class="to_register">Join us</a> Or
  ...
  <option value="Female">Female</option>
								...
								<p> 
                                    ...
                                    <input id="usernamesignup" name="pob" required="required" type="text" placeholder="Maseno" />
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Group</label>
                                    <select name="Group" id="usernamesignup" required="required" type="text">
  <option value="None">None</option>
  <option value="Praise and Worship">Government Personel</option>
  <option value="Ushering">Private Organisation</option>
  <option value="Hostessing">Individual</option>
</select> 
                                </p>
								 <p> 
